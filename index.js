...
gsap.from('header img', { opacity: 0, duration: 1, delay: 3.5, x: 200 })
gsap.from('.footer-left', { opacity: 0, duration: 3, delay: 1, x: -200 })
gsap.from('.footer-right', { opacity: 0, duration: 3, delay: 1, x: 200 })
